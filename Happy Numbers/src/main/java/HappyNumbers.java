...
public class HappyNumbers {
	...
	public static void main(String[] args) {
		...
		boolean isHappy = happy(numberString);
		System.out.println(isHappy);
		

	}

	private static boolean happy(String numberString) {
		...
		for(int i = 0; i < numbers.length; i++) {
			nextNum += (((int)numberString.charAt(i)-48) * ((int)numberString.charAt(i)-48));
		}
		return happy(nextNum.toString());
